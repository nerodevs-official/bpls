...
export default function MoIndex() {
    const { eo, filters, departments, role } = usePage().props;
    const headers = eo?.headers ?? [];
    const tasks = eo?.tasks ?? [];
    const pagination = eo?.pagination ?? {};
    ...
    const getVal = (task, headerId) =>
        task?.values?.find((v) => v.eo_header_id === headerId)?.value ?? "";
    ...
    const makeHref = (name, params) => {
        try {
            ...
            if (name === "executive-order.show")
                return `/executive-order/${params?.[0] ?? params}`;
            if (name === "executive-order.edit")
                return `/executive-order/${params?.[0] ?? params}/edit`;
            return "#";
        }
    };
    ...
    return (
        <AuthenticatedLayout
            ...
            // }
        >
            <Head title={eo?.name || "Executive Order"} />
                ...
                <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                    <div>
                        ...
                        <p className="mt-1 text-sm text-gray-600">
                            Manage and track all executive orders in one place.
                        </p>
                    </div>
                    <Link
                            ...
                            <tbody className="bg-white divide-y divide-gray-200">
                                {(() => {
                                    ...
                                    return visibleTasks.length > 0 ? (
                                                                    ...
                                                                    <td key={h.id} className="px-3 py-1">
                                                                        <button
                                                                            ...
                                                                            onClick={(e) => {
                                                                                ...
                                                                                if (!isFiled) {
                                                                                    router.put(
                                                                                        route("executive-order.update-status", {
                                                                                            id: task.id,
                                                                                        }),
                                                                                        {
                                                                                            status: "Filed",
                                                                    ...
                                                                    {openDropdownId === task.id && (
                                                                        ...
                                                                        >
                                                                            <div className="py-1">
                                                                                <Link
                                                                                    href={showHref}
                                                                                    className="flex items-center gap-2 px-3 py-1 text-sm text-gray-700 hover:bg-gray-100 transition-colors"
                                                                                ...
                                                                                {(() => {
                                                                                    ...
                                                                                    return canEdit ? (
                                                                                        ...
                                                                                        <div className="flex items-center gap-2 px-3 py-1 text-sm text-gray-400 cursor-not-allowed">
                                                                                            <Pencil className="h-4 w-4" />
                                                                                            Edit
                                                                                        </div>
                                                                                    );
                                        ...
                                        <tr>
                                            <td colSpan={headerMeta.length + (role !== "Messenger" ? 1 : 0)} className="px-4 py-8 text-center">
                                                <div className="text-sm text-gray-500">
                                                    No executive orders found based on your permissions or filters.
                                                </div>
                                            </td>
                                        </tr>
                                    );
