...
export default function MoEdit({ memo }) {
    ...
    const { data, setData, post, progress, errors, processing } = useForm({
        ...
        date_of_effectivity: memo.date_of_effectivity
            ? new Date(memo.date_of_effectivity).toISOString().split("T")[0]
            : "",
        date_issued: memo.date_issued
            ? new Date(memo.date_issued).toISOString().split("T")[0]
            : "",
        status: memo.status || "Not Started",
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        post(route("memo-order.update", memo.id), {
            preserveState: true,
            preserveScroll: true,
            forceFormData: true,
            onSuccess: () => {
    ...
    const handleFileDelete = () => {
        ...
        router.delete(route("memo-order.delete-file", memo.id), {
            preserveScroll: true,
            onSuccess: () => {
                setData("file", null);
                memo.file_path = null;
    ...
    const handleDelete = () => {
        router.delete(route("memo-order.destroy", memo.id), {
            preserveScroll: true,
        });
    };
    ...
    const currentFile = memo.file_path || null;
            ...
            header={
                <div className="flex items-center gap-2">
                    ...
                    <h2 className="text-xl font-semibold leading-tight text-gray-800">
                        Edit Memorandum Order
                    </h2>
                </div>
            }
        >
            <Head title="Edit Memorandum Order" />

            <ConfirmModal
                isOpen={isDeleteModalOpen}
                title="Delete Memorandum Order?"
                message="Are you sure you want to delete this Memorandum Order? This action cannot be undone."
                ...
                <div className="mx-auto overflow-hidden bg-white border shadow-sm rounded-xl border-slate-200">
                    ...
                    <div className="flex items-center justify-end gap-2 px-5 py-3 border-t border-slate-200 bg-slate-50">
                        ...
                        >
                            ...
                            {processing ? "Saving..." : "Update Memo Order"}
                        </button>
                    </div>
                </div>
            </form>
