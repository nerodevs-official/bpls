// resources/js/Pages/Order/SpecialOrder/MoCreate.jsx
...
export default function MoCreate() {
    ...
    const submit = (e) => {
        e.preventDefault();
        post(route("special-order.store"), {
            forceFormData: true,
    ...
    return (
        ...
        >
            <Head title="Create Special Order" />
            <form onSubmit={submit} className="p-4">
                <div className="mx-auto overflow-hidden bg-white border shadow-sm rounded-xl border-slate-200">
                    ...
                    <div className="grid grid-cols-1 gap-4 p-5 sm:grid-cols-2">
                        ...
                        <Field label="Special Order No." error={errors.so_no}>
                            <input
                                type="text"
                                className={inputCls}
                                placeholder="e.g., 59"
                        ...
                        <div className="sm:col-span-2">
                            <Field label="Subject" error={errors.subject}>
                                <input
                                    type="text"
                                    className={inputCls}
                                    placeholder="Enter Special subject"
                                    value={data.subject}
                                    onChange={(e) =>
                    ...
                    <div className="flex items-center justify-end gap-2 px-5 py-3 border-t border-slate-200 bg-slate-50">
                        ...
                        >
                            ...
                            {processing ? "Saving..." : "Save Special Order"}
                        </button>
                    </div>
                </div>
            </form>
