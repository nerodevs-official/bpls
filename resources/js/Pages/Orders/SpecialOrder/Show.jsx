...
export default function Show({ so }) {
    ...
    // Derived State
    const currentStepIndex = STATUS_STEPS.indexOf(so.status);
    ...
    return (
            ...
            header={
                <div className="flex flex-col items-start w-full gap-4 sm:flex-row sm:items-center sm:justify-between">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        {canEdit && (
                            <Link
                                href={route("special-order.edit", so.id)}
        ...
        >
            <Head title={`SO ${so.so_no} - ${so.subject}`} />
                        ...
                        <div className="space-y-6 lg:col-span-2 lg:sticky lg:top-24">
                                ...
                                <div className="p-6 sm:p-8">
                                    ...
                                    <div className="flex flex-wrap gap-4 pt-6 mt-6 border-t border-gray-100">
                                        <div className="flex items-center gap-2 px-3 py-1.5 text-sm font-medium text-gray-700 bg-gray-50 rounded-lg border border-gray-200">
                                            ...
                                            <span>Issued: {so.date_issued || "N/A"}</span>
                                        </div>
                                         <div className="flex items-center gap-2 px-3 py-1.5 text-sm font-medium text-gray-700 bg-gray-50 rounded-lg border border-gray-200">
                                            <Building2 className="w-4 h-4 text-gray-400" />
                                            <span>{so.originating_department || "Unknown Dept"}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="bg-white shadow-sm rounded-xl border border-gray-100">
                                ...
                                <div className="p-6 text-gray-600 whitespace-pre-wrap">
                                    {so.recipients || "No recipients specified"}
                                </div>
                            </div>
                                    ...
                                    {so.file_path ? (
                                        <div className="group">
                                            ...
                                            <div className="grid grid-cols-2 gap-3">
                                                 <button
                                                    onClick={() => openFilePreview(so.file_path)}
                                ...
                                <div className="p-6">
                                    {isRejected ? (
                                        <div className="p-4 rounded-lg bg-red-50 border border-red-100 text-red-700">
                                            ...
                                            <p className="text-sm">This Special Order has been rejected.</p>
                                        </div>
                                    ) : (
