...
export default function Edit({ titlehousing }) {
    ...
    const { data, setData, post, progress, processing, errors } = useForm({
        ...
        status: titlehousing.status || "Not Started",
        time: titlehousing.time || "",
        start_date: formatDateForInput(titlehousing.start_date),
        due_date: formatDateForInput(titlehousing.due_date),
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        post(route("titlehousing.update", titlehousing.id), {
            preserveState: true,
            preserveScroll: true,
    ...
    const handleFileDelete = () => {
        ...
        router.delete(route("titlehousing.delete-file", titlehousing.id), {
            preserveScroll: true,
            onSuccess: () => {
                setData("file", null);
                titlehousing.file_path = null;
            },
        });
    };

    const handleDelete = () => {
        router.delete(route("titlehousing.destroy", titlehousing.id), {
            preserveScroll: true,
        });
    };
    ...
    const currentFile = titlehousing.file_path || null;
            ...
            >
                <div className="mx-auto overflow-hidden bg-white border shadow-sm rounded-xl border-slate-200">
                    ...
                    <div className="grid grid-cols-1 gap-4 p-5 sm:grid-cols-2">
                        ...
                        {/* ✅ Assigned To dropdown (saves user name) */}
                        <Field
                            label="Assigned To"
                        ...
                        <div className="sm:col-span-2">
                            <Field label="Time" error={getError("time")}>
                                <input
                                    type="time"
                                    className={inputCls}
                                    placeholder="Optional (e.g., 09:00 AM)"
                                    value={data.time}
                                    onChange={(e) =>
                    ...
                    <div className="flex items-center justify-end gap-2 px-5 py-3 border-t border-slate-200 bg-slate-50">
                        ...
                        >
                            ...
                            {processing ? "Saving..." : "Update Title Housing"}
                        </button>
                    </div>
                </div>
            </form>
