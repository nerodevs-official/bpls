...
export default function Show({ titlehousing }) {
    ...
    // Derived State
    const currentStepIndex = STATUS_STEPS.indexOf(titlehousing.status);
    const isRejected = titlehousing.status === "Rejected";
    ...
    return (
            ...
            header={
                <div className="flex flex-col items-start w-full gap-4 sm:flex-row sm:items-center sm:justify-between">
                    <div>
                        <div className="flex items-center gap-3">
                            ...
                            <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-50 text-blue-700 border border-blue-100 max-w-[200px] truncate">
                                {titlehousing.subject || "No Subject"}
                            </span>
                        </div>
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        {canEdit && (
                            <Link
                                href={route("titlehousing.edit", titlehousing.id)}
        ...
        >
            <Head title={`Title Housing - ${titlehousing.title}`} />
                            ...
                            <div className="overflow-hidden bg-white shadow-sm rounded-xl border border-gray-100">
                                <div className="p-6 sm:p-8">
                                    <div className="mb-6">
                                        ...
                                        <p className="mt-2 text-lg text-gray-600">{titlehousing.subject}</p>
                                    </div>
                                    ...
                                    <div className="flex flex-wrap gap-4 pt-6 mt-6 border-t border-gray-100">
                                        <div className="flex items-center gap-2 px-3 py-1.5 text-sm font-medium text-gray-700 bg-gray-50 rounded-lg border border-gray-200">
                                            ...
                                            <span>Starts: {titlehousing.start_date || "N/A"}</span>
                                        </div>
                                         <div className="flex items-center gap-2 px-3 py-1.5 text-sm font-medium text-gray-700 bg-gray-50 rounded-lg border border-gray-200">
                                            <Calendar className="w-4 h-4 text-gray-400" />
                                            <span>Due: {titlehousing.due_date || "N/A"}</span>
                                        </div>
                                         <div className="flex items-center gap-2 px-3 py-1.5 text-sm font-medium text-gray-700 bg-gray-50 rounded-lg border border-gray-200">
                                            <Clock className="w-4 h-4 text-gray-400" />
                                            <span>{titlehousing.time || "No time set"}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div className="flex items-center gap-4 p-6">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-base font-semibold text-gray-900">
                                            {titlehousing.assigned_to || "Unassigned"}
                                        </p>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    {titlehousing.file_path ? (
                                        <div className="group">
                                            ...
                                            <div className="grid grid-cols-2 gap-3">
                                                 <button
                                                    onClick={() => openFilePreview(titlehousing.file_path)}
                                ...
                                <div className="p-6">
                                    {isRejected ? (
                                        <div className="p-4 rounded-lg bg-red-50 border border-red-100 text-red-700">
                                            ...
                                            <p className="text-sm">This Title Housing entry has been rejected.</p>
                                        </div>
                                    ) : (
