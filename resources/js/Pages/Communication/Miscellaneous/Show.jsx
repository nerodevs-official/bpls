...
export default function Show({ miscellaneous }) {
    ...
    // Derived State
    const currentStepIndex = STATUS_STEPS.indexOf(miscellaneous.status);
    const isRejected = miscellaneous.status === "Rejected";
    ...
    return (
                ...
                <div className="flex flex-col items-start w-full gap-4 sm:flex-row sm:items-center sm:justify-between">
                    <div>
                        <div className="flex items-center gap-3">
                            ...
                            <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-50 text-blue-700 border border-blue-100 max-w-[200px] truncate">
                                {miscellaneous.subject || "No Subject"}
                            </span>
                        </div>
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        {canEdit && (
                            <Link
                                href={route("miscellaneous.edit", miscellaneous.id)}
        ...
        >
            <Head title={`Misc - ${miscellaneous.title}`} />
                            ...
                            <div className="overflow-hidden bg-white shadow-sm rounded-xl border border-gray-100">
                                <div className="p-6 sm:p-8">
                                    <div className="mb-6">
                                        ...
                                        <p className="mt-2 text-lg text-gray-600">{miscellaneous.subject}</p>
                                    </div>
                                    ...
                                    <div className="flex flex-wrap gap-4 pt-6 mt-6 border-t border-gray-100">
                                        <div className="flex items-center gap-2 px-3 py-1.5 text-sm font-medium text-gray-700 bg-gray-50 rounded-lg border border-gray-200">
                                            ...
                                            <span>Starts: {miscellaneous.start_date || "N/A"}</span>
                                        </div>
                                         <div className="flex items-center gap-2 px-3 py-1.5 text-sm font-medium text-gray-700 bg-gray-50 rounded-lg border border-gray-200">
                                            <Calendar className="w-4 h-4 text-gray-400" />
                                            <span>Due: {miscellaneous.due_date || "N/A"}</span>
                                        </div>
                                         <div className="flex items-center gap-2 px-3 py-1.5 text-sm font-medium text-gray-700 bg-gray-50 rounded-lg border border-gray-200">
                                            <Clock className="w-4 h-4 text-gray-400" />
                                            <span>{miscellaneous.time || "No time set"}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div className="flex items-center gap-4 p-6">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-base font-semibold text-gray-900">
                                            {miscellaneous.assigned_to || "Unassigned"}
                                        </p>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    {miscellaneous.file_path ? (
                                        <div className="group">
                                            ...
                                            <div className="grid grid-cols-2 gap-3">
                                                 <button
                                                    onClick={() => openFilePreview(miscellaneous.file_path)}
                                ...
                                <div className="p-6">
                                    {isRejected ? (
                                        <div className="p-4 rounded-lg bg-red-50 border border-red-100 text-red-700">
                                            ...
                                            <p className="text-sm">This Miscellaneous entry has been rejected.</p>
                                        </div>
                                    ) : (
